...
export const countryDatabase: Record<string, CountryData> = {
  // ========== AFRICA - EAST ==========
  KE: { name: "Kenya", code: "KE", region: "Africa", subregion: "East Africa", currency: "KES", developmentLevel: "lower-middle", constructionCosts: { basic: 310, standard: 500, improved: 735 }, infrastructure: { waterPerConnection: 800, sewerPerConnection: 1200, roadsPerMeter: 80 }, occupancy: { oneBedroom: 2.5, twoBedroom: 3.5, threeBedroom: 4.5 }, utilities: { waterLitersPerPerson: 50, electricityKwhPerPerson: 2.5, wasteKgPerPerson: 0.6 }, laborCostPercentage: 35, typicalProjectBudgets: { small: { min: 500000, max: 2000000 }, medium: { min: 2000000, max: 8000000 }, large: { min: 8000000, max: 50000000 } } },
