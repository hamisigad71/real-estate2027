            ...
            <div className="hidden md:flex items-center gap-6">
              <nav className="flex items-center gap-1.5 bg-slate-50/50 p-1 rounded-full border border-slate-200/60 backdrop-blur-sm">
                <Button
                  ...
                  className="px-5 py-2 h-auto text-[10px] font-black uppercase tracking-widest text-slate-500 hover:text-[#7A3F91] hover:bg-white hover:shadow-sm rounded-full transition-all duration-300 flex items-center gap-2 group"
                >
                ...
                <Button
                  ...
                  className="px-5 py-2 h-auto text-[10px] font-black uppercase tracking-widest text-slate-500 hover:text-slate-900 hover:bg-white hover:shadow-sm rounded-full transition-all duration-300 flex items-center gap-2 group"
                >
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-full flex flex-col justify-center text-white">
          ...
          >
            ...
            <h2 className="text-3xl sm:text-5xl font-bold mb-4 max-w-2xl leading-[1.1] font-rethink tracking-tight">
              ...
              <span className="text-transparent bg-clip-text bg-linear-to-r from-[#C59DD9] to-[#7A3F91]">
                Sustainable Housing.
              </span>
            </h2>
            <p className="text-base text-slate-300 max-w-xl font-medium leading-relaxed">
              Harness advanced computational design to analyze, simulate, and
              plan high-density housing projects with unprecedented accuracy.
            </p>
          </motion.div>
        </div>
          ...
          <Card className="border-0 shadow-xl bg-white/90 backdrop-blur-md overflow-hidden hover:-translate-y-1 transition-transform">
            <CardContent className="p-6">
              <div className="flex items-center justify-between mb-4">
                ...
                <Badge
                  variant="outline"
                  className="text-[#7A3F91] border-[#C59DD9]/30"
                >
                  Total Projects
                </Badge>
              </div>
          ...
          <div className="lg:col-span-2">
            <div className="flex items-center justify-between mb-6">
              <div>
                ...
                <p className="text-xs text-slate-500">
                  Manage and track your housing plans
                </p>
              </div>
              <Button
              ...
              <CardContent className="px-6 py-5">
                <div className="grid grid-cols-3 gap-3">
                  ...
                  <div className="text-center p-3 rounded-xl bg-[#F2EAF7] border border-[#C59DD9]/30">
                    <div className="text-xl font-black text-[#7A3F91] leading-none">
                      {projects.length}
                    </div>
                    <div className="text-[9px] text-[#C59DD9] font-bold uppercase tracking-wider mt-2">
                      Active
                    </div>
                  </div>
                  <div className="text-center p-3 rounded-xl bg-slate-50 border border-slate-100/50">
                  ...
                  <div className="w-full bg-slate-100 rounded-full h-2 overflow-hidden">
                    <motion.div
                      ...
                      animate={{
                        width:
                          projects.length > 0
                            ? `${Math.min((stats.scenarioCount / (projects.length * 3)) * 100, 100)}%`
                            : "0%",
                      }}
              ...
              <CardContent className="relative z-10 space-y-2 px-4 pb-4">
                <div className="bg-white/10 p-2.5 rounded-lg border border-white/10">
                  <p className="text-xs font-semibold mb-0.5 flex items-center gap-1.5">
                    <Layout className="h-3.5 w-3.5 text-[#C59DD9]" />{" "}
                    Multi-Scenario Testing
                  </p>
                  <p className="text-[10px] text-white/80 leading-relaxed">
                    Compare layouts to maximize density while maintaining
                    livability.
                  </p>
                </div>
                <div className="bg-white/10 p-2.5 rounded-lg border border-white/10">
                  <p className="text-xs font-semibold mb-0.5 flex items-center gap-1.5">
                    <Building className="h-3.5 w-3.5 text-[#C59DD9]" /> Density
                    Optimization
                  </p>
                  <p className="text-[10px] text-white/80 leading-relaxed">
                    Use zoning checks to ensure compliance with local
                    regulations.
                  </p>
                </div>
                <Button
                  variant="secondary"
                  className="w-full bg-white text-[#2B0D3E] hover:bg-[#F2EAF7] border-0 h-8 text-xs font-semibold"
                >
